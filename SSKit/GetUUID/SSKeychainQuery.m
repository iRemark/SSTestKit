...
- (BOOL)save:(NSError *__autoreleasing *)error {
	OSStatus status = _SSKeychainErrorBadArguments;
...
+ (NSError *)errorWithCode:(OSStatus) code {
	...
	switch (code) {
		...
		case _SSKeychainErrorBadArguments: message = NSLocalizedStringFromTable(@"SSKeychainErrorBadArguments", @"SSKeychain", nil); break;
	...
	return [NSError errorWithDomain:_kSSKeychainErrorDomain code:code userInfo:userInfo];
}
