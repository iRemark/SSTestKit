...
/**
 ...
 platform.
 */
typedef NS_ENUM(OSStatus, _SSKeychainErrorCode) {
	/** Some of the arguments were invalid. */
	_SSKeychainErrorBadArguments = -1001,
};

/** SSKeychain error domain */
extern NSString *const _kSSKeychainErrorDomain;

/** Account name. */
extern NSString *const _kSSKeychainAccountKey;
 ...
 */
extern NSString *const _kSSKeychainCreatedAtKey;

/** Item class. */
extern NSString *const _kSSKeychainClassKey;

/** Item description. */
extern NSString *const _kSSKeychainDescriptionKey;

/** Item label. */
extern NSString *const _kSSKeychainLabelKey;

/** Time the item was last modified.

 The value will be a string.
 */
extern NSString *const _kSSKeychainLastModifiedKey;

/** Where the item was created. */
extern NSString *const _kSSKeychainWhereKey;
